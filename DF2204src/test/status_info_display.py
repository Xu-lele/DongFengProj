...
import DF2204src.component_ui.status_info_display as status_info_display
import DF2204src.component.classOfDF2204 as classOfDF2204
import threading
import DF2204src.component.classOfTractorStatusDataRecord as classOfTractorStatusDataRecord
...
def button_serial_clicked(ui):
    if os.system("../chmod_batch/sudo_chmod_777") == 0:
...
def button_pcan_clicked(ui):
    if os.system("../chmod_batch/modprobe_peak_usb_forDongFeng2204") == 0:
...
def button_vcan_clicked(ui):
    if os.system("../chmod_batch/modprobe_vcan") == 0:
